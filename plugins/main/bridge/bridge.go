...
import (
	...
	"github.com/heartlock/vmni/pkg/ip"
	"github.com/heartlock/vmni/pkg/ipam"
	//"github.com/heartlock/vmni/pkg/ns"
	"github.com/heartlock/vmni/pkg/skel"
	"github.com/heartlock/vmni/pkg/types"
	"github.com/heartlock/vmni/pkg/utils"
...
func cmdAdd(args *skel.CmdArgs) error {
	...
	/*if err := netns.Do(func(_ ns.NetNS) error {
		...
		if err := ip.SetHWAddrByIP(args.IfName, result.IP4.IP.IP, nil ); err != nil {
			return err
		}
